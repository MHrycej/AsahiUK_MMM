...
auto_variable_selection(multiples_pna_glass_620ml_1pack, import_file, "c_bp_multiples_total")
...
write.csv(final_decomp_export, file = file.path(directory_path, "/decomps/decomp_multiples_pna_glass_620ml_1pack.csv"), row.names = FALSE)
