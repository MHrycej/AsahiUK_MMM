...
auto_variable_selection(multiples_pna_glass_250ml_4pack, import_file, "m_influencers_peroni_")
...
plot_line2("mod_vol_multiples_pna_glass_250ml_4pack", "	gt_lager", import_file)
