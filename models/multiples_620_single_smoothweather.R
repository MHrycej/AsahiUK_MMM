...
import_file$rel_price_multiples_glass_620ml_1pack_1 <- import_file$mod_bp_multiples_pna_glass_620ml_1pack/import_file$c_bp_multiples_total_btl_330_single
...
formula.01 = mod_vol_multiples_pna_glass_620ml_1pack~ #dependent variable
 ...
 # w_sunhour_smoothed+
  ...
  cat_smooth_vol_multiples_glass_single_v1+
  ...
  c_discount_multiples_stella_artois_can_440_ml_4_pack+
  ...
  #atan(cm_total_budweiser_sp_adstock20/290000)+
  #atan(cm_total_cruzcampo_sp_adstock20/120000)
  #dummy_trend
...
multiples_pna_glass_620ml_1pack <- lm(formula = formula.01, data = import_file)
model_stats(multiples_pna_glass_620ml_1pack, date_var = import_file$Date)
...
actual_vs_fitted_plot(multiples_pna_glass_620ml_1pack, import_file, "cat_smooth_vol_multiples_glass_single_v1")

# Automatic variable selection
auto_variable_selection(multiples_pna_glass_620ml_1pack, import_file, "own_discount_multiples")
...
plot_line2("c_bp_multiples_stella_artois_can_440_ml_4_pack", "c_avp_multiples_stella_artois_can_440_ml_4_pack", import_file)


# Residual plot
residuals_vs_variable_plot(multiples_pna_glass_620ml_1pack, import_file, "mod_discount_multiples_pna_glass_620ml_1pack")
...
model_decomp(multiples_pna_glass_620ml_1pack)

final_decomp_export <- model_decomp(multiples_pna_glass_620ml_1pack)
write.csv(final_decomp_export, file = file.path(directory_path, "/decomps/decomp_multiples_pna_glass_620ml_1pack_smoothweather.csv"), row.names = FALSE)
