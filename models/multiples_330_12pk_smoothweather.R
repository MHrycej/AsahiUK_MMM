...
import_file$mod_discount_multiples_pna_glass_330ml_12pack_lag6 <- lag(import_file$mod_discount_multiples_pna_glass_330ml_12pack,6) %>% replace(is.na(.), 0)
#import_file$gt_peroni_lag1 <- lag(import_file$gt_peroni,1) %>% replace(is.na(.), 0)

# create custom variables
#import_file$rel_price_multiples_glass_330ml_12pack_1 <- import_file$mod_bp_multiples_pna_glass_330ml_12pack/import_file$c_bp_multiples_corona_btl_330_ml_10_pack
import_file$mod_distdisc_multiples_glass_330ml_12pack <- import_file$mod_dist_multiples_pna_glass_330ml_12pack*import_file$mod_discount_multiples_pna_glass_330ml_12pack
...
formula.01 = mod_vol_multiples_pna_glass_330ml_12pack~ #dependent variable
  ...
  #mod_distdisc_multiples_glass_330ml_12pack+
  #mod_discount_multiples_pna_glass_330ml_12pack_lag6+
  #mod_discount_multiples_pna_glass_330ml_12pack_bel15+
  #mod_discount_multiples_pna_glass_330ml_12pack_15to25+
  #mod_discount_multiples_pna_glass_330ml_12pack_over25+
  ...
  c_discount_multiples_birra_moretti_can_330_ml_6_pack+
  e_cci+
  #e_rpi+
  #e_unemployment+
  ...
  cat_smooth_vol_multiples_glass_large_pack_v1+
  #dummy_month_jan+
  #dummy_month_feb+
  #dummy_month_mar+
  #dummy_month_apr+
  ...
  #atan(cm_total_madri_sp_adstock40/250000)
...
heatmap(
  ...
  expense_channel = "cm_total_madri_sp",
...
plot_line2("c_avp_multiples_birra_moretti_can_330_ml_6_pack", "c_bp_multiples_birra_moretti_can_330_ml_6_pack", import_file)
...
write.csv(final_decomp_export, file = file.path(directory_path, "/decomps/decomp_multiples_pna_glass_330ml_12pack_smoothweather.csv"), row.names = FALSE)
