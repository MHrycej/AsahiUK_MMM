...
auto_variable_selection(multiples_330_10pk, import_file, "m_ooh_peroni")
...
actual_vs_fitted_plot(multiples_330_10pk, import_file, "")

# Residual plot
residuals_vs_variable_plot(multiples_330_10pk, import_file, "gt_peroni")

create_residuals_histogram(multiples_330_10pk, import_file)

# Price elasticity
calculate_price_elasticity(multiples_330_10pk, "mod_vol_multiples_pna_glass_330ml_10pack", "mod_bp_multiples_pna_glass_330ml_10pack", import_file)
