...
auto_variable_selection(multiples_pna_glass_330ml_10pack, import_file, "e_")
...
actual_vs_fitted_plot(multiples_pna_glass_330ml_10pack, import_file, "rel_price_multiples_glass_330ml_10pack_1")
