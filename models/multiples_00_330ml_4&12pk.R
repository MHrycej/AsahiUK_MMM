...
plot_line2("mod_vol_multiples_pna00_glass_330ml_4_12pack", "	gt_lager", import_file)
...
write.csv(final_decomp_export, file = file.path(directory_path, "/decomps/decomp_multiples_pna00_glass_330ml_4_12pack.csv"), row.names = FALSE)
