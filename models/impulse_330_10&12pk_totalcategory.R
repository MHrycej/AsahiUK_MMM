...
#### formula definition ####
formula.01 = mod_vol_impulse_pna_glass_330ml_10_12pack~ #dependent variable
  mod_dist_impulse_pna_glass_330ml_10_12pack+
  mod_bp_impulse_pna_glass_330ml_10_12pack+
  mod_discount_impulse_pna_glass_330ml_10_12pack+
  cat_vol_impulse_glass_10_pack+
  cat_vol_impulse_glass_12_pack+
  #dummy_month_jan+
  #dummy_month_feb+
  #dummy_month_mar+
  #dummy_month_apr+
...
impulse_pna_glass_330ml_10_12pack <- lm(formula = formula.01, data = import_file)
model_stats(impulse_pna_glass_330ml_10_12pack, date_var = import_file$Date)
...
actual_vs_fitted_plot(impulse_pna_glass_330ml_10_12pack, import_file, "cat_vol_impulse_glass_12_pack")

# Automatic variable selection
auto_variable_selection(impulse_pna_glass_330ml_10_12pack, import_file, "cat_vol_impulse")
...
# Residual plot
residuals_vs_variable_plot(impulse_pna_glass_330ml_10_12pack, import_file, "mod_discount_impulse_pna_glass_330ml_10_12pack")

create_residuals_histogram(impulse_pna_glass_330ml_10_12pack, import_file)

# Price elasticity
calculate_price_elasticity(impulse_pna_glass_330ml_10_12pack, "mod_vol_impulse_pna_glass_330ml_10_12pack", "mod_bp_impulse_pna_glass_330ml_10_12pack", import_file)
...
model_decomp(impulse_pna_glass_330ml_10_12pack)
