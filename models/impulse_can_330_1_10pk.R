...
plot_line2("mod_vol_impulse_pna_can_330ml_1_10pack", "	gt_lager", import_file)
...
# Price elasticity
calculate_price_elasticity(impulse_pna_can_330ml_1_10pack, "mod_vol_impulse_pna_can_330ml_1_10pack", "mod_bp_impulse_pna_can_330ml_1_10pack", import_file)
...
write.csv(final_decomp_export, file = file.path(directory_path, "/decomps/decomp_impulse_pna_can_330ml_1_10pack.csv"), row.names = FALSE)
